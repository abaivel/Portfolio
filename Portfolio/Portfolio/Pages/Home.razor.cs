...
namespace Portfolio.Pages
{
    public partial class Home
    {
        ...
        public List<string> LanguagesAndFrameworks { get; set; } = new List<string>() { "Java", "JEE", "Servlets", "JSP", "JPA", "Développement d'applications Android", "Kotlin", "Python", "Django", "C#", "Blazor", "ASP.NET Core", "Entity Framework", "HTML", "CSS", "Javascript", "React.js", "PHP", "SQL" };
